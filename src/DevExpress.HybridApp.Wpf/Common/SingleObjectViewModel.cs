...
namespace DevExpress.DevAV.Common {
    ...
    public abstract partial class SingleObjectViewModel<TEntity, TPrimaryKey, TUnitOfWork> : SingleObjectViewModelBase<TEntity, TPrimaryKey, TUnitOfWork>
        ...
        protected override CollectionViewModelBase<TDetailEntity, TDetailProjection, TDetailPrimaryKey, TUnitOfWork> CreateDetailsCollectionViewModel<TDetailEntity, TDetailProjection, TDetailPrimaryKey>(
            ...
            bool ignoreSelectEntityMessage, UnitOfWorkPolicy unitOfWorkPolicy) {
            return CollectionViewModel<TDetailEntity, TDetailProjection, TDetailPrimaryKey, TUnitOfWork>.CreateProjectionCollectionViewModel(
                UnitOfWorkFactory,
                getRepositoryFunc,
                predicate,
